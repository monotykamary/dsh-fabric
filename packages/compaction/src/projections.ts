/** Adapted from pi-fabric's deterministic compaction projection (projections.ts). */
import { clipUtf8, omissionLine, sampleAddressed, sampleAddressedFrom } from "./bounds.ts";
import {
  firstLine,
